# coding=utf-8
"""
该实现经过pyinstaller打包成exe后不生效。
"""
from ctypes import wintypes, windll, Structure, c_int, c_uint, c_void_p, c_long, POINTER, cast, CFUNCTYPE
import win32con
...
class MyEvent:
    ...
    def start_mouse_hook(self):
        ...
        self.mouse_hd = SetWindowsHookEx(
            ...
            GetModuleHandle(None),
            0)
        print(f'mouse_hd={self.mouse_hd}')
        MyEvent.wait_for_msg()
